...
structure Test = ChunkedseqTestFn(
    ...
    val metaDataTrusted = Trusted.MetaData { measure = fn _ => raise Fail "", itemOverwrite = false }
    val metaDataUntrusted = Untrusted.MetaData { measure = fn _ => raise Fail "", itemOverwrite = false })
